...
abstract contract ERC404 is IERC404 {
    ...
    function _transferERC20WithERC721(address from_, address to_, uint256 value_) internal virtual returns (bool) {
        ...
        if (isFromERC721TransferExempt && isToERC721TransferExempt) {
            ...
            if ((erc20BalanceOfSenderBefore - fractionalAmount) / units < (erc20BalanceOfSenderBefore / units)) {
                _withdrawAndStoreERC721(from_);
            }
            ...
            if ((erc20BalanceOfReceiverBefore + fractionalAmount) / units > (erc20BalanceOfReceiverBefore / units)) {
                _retrieveOrMintERC721(to_);
            }
        }
